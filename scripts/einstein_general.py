...
N2 = 200
# Polytopic constant
K_ix = 99 # Array index for K_NS = 100
K_NS_list = np.arange(1, N1+1)
#K_NS_list = np.array([100, 101, 102, 103, 104])
# Polytropic index
n = 1
...
# Mass, radius, and rest mass vector preallocation
M = np.empty((N1, N2))
R = np.empty((N1, N2))
M_p = np.empty((N1, N2))
